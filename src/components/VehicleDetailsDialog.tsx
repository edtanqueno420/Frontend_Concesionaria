...
export function VehicleDetailsDialog({
  ...
  // ✅ imagen de mongo (la que ya pasas como vehiculo.imagenUrl)
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-6 space-y-6">
            {/* ✅ Imagen Principal (premium: blur + imagen encima) */}
            ...
            <div className="bg-gradient-to-r from-red-50 to-slate-50 p-6 rounded-xl border-2 border-red-200">
              ...
              <p className="text-4xl font-bold text-red-600">
                ${precioConRetoma.toLocaleString()}
              </p>
            </div>
            ...
            {/* (Opcional) Si luego haces calculadora, aquí va */}
            {showCalculator && (
              <div className="mt-4 p-4 bg-slate-50 rounded-lg border-2 border-slate-200 text-slate-700">
            ...
            <div className="flex gap-3">
              ...
              <button className="flex-1 px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold shadow-lg transition-all flex items-center justify-center gap-2">
